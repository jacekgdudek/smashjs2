...
CombinationScene.prototype = new Scene(combinationSceneStructure);

CombinationScene.prototype.init() = function {
	...
	// Rotation images rotate around an unexpected point (not the middle)
...
Combination.prototype.update = function() {
	this.visuals[0].bitmap.rotation = inputArray[2].rotation;
	//-------update sthetoscope
...
CombinationScene.prototype.handleKeyDown = function(evt) {
